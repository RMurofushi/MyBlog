...
class MassagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create massage" do
    assert_difference('Massage.count') do
      post massages_url, params: { massage: { message: @massage.message, title: @massage.title } }
    end
  ...
  test "should update massage" do
    patch massage_url(@massage), params: { massage: { message: @massage.message, title: @massage.title } }
